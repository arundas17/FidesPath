...
import addservices from '../assets/additional.jpg'
  ...
  return (
    <div className="fidesmainaboutus">
       ...
       title="Additional Service"
        breadcrumbItems={[
          { text: 'Home', link: '/' },
          { text: 'Additional Service', link: '/services/additionalservices' },
        ]}
        
        backgroundImage={addservices}
                ...
                <div className="fidesdeatlcards-wrapper">
                        <div className="fidesaboutcards">
                           ...
                           <div className="carddetailsaboutus">
                            <h3 className="fidespath-mainheader outfit" style={{ fontSize: '40px', lineHeight:'1.3' }}>Additional Services</h3>
